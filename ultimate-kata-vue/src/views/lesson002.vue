  ...
  <div class="lesson">
    <div class="code-bg">
      <div class="prompt">
        ...
        <h2 class="white-txt">
          Add <span class="string">'Bulldog'</span> to the start of the Array
        </h2>
      </div>
      ...
      <div class="attempt">
        <div class="greyed-out">
          ...
          <p><span class="func">let</span> <span class="vari">dogBreeds </span>= [];</p>
          <p>
            <span class="vari">dogBreeds </span>= [<span class="string">'Poodle'</span>, <span class="string">'Chihuahua'</span>, <span class="string">'Greyhound'</span>];
          </p>
          <br />
          <p>console.<span class="method">log</span>(<span class="string">'Before = '</span> <span class="operator">+ </span><span class="vari">dogBreeds</span> )</p>
        </div>
      ...
      <hr /><hr />
      <div class="greyed-out">
        <p>console.<span class="method">log</span>(<span class="string">'After = '</span> <span class="operator">+ </span><span class="vari">dogBreeds</span> );</p>
      </div>
...
`,
  ...
  mounted() {
    ...
    localStorage.getItem('lesson2State') ? (this.aceEditor.session.setValue(localStorage.getItem('lesson2State'))) : this.aceEditor.session.setValue(this.lessonCode);
  ...
  methods: {
    ...
    saveLesson() {
      ...
      let lessonString = this.aceEditor.getValue();
      localStorage.setItem('lesson2State', lessonString)
    },
    submit() {
      ...
      iframe.src = URL.createObjectURL(blobber1);
        ...
        const func = new Function(this.preLessonCode + lessonString + this.postLessonCode +'return dogBreeds;' );
        let x = func();
